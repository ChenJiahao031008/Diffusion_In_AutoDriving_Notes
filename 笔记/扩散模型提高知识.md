...
+ 参考链接：
  ...
  1. https://zhuanlan.zhihu.com/p/603740431：Rectified 作者介绍和回答
...
+ 参考链接：https://zhuanlan.zhihu.com/p/714150390

### 1. 核心贡献：

1. 不使用 Classifier-Free Guidance 的指引蒸馏
2. 为不同分辨率图像调整流匹配噪声调度
3. 用二维旋转式位置编码 RoPE 代替二维正弦位置编码
4. 在原 Stable Diffusion 3 双流 Transformer 块后添加并行单流 Transformer 块.
